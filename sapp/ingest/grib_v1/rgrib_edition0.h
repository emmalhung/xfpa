...
static const ModelDefinitions ModelDefs[] =
	{
		/*** CMC STANDARD ... uses Edition 1 ***/

		/*** NMC STANDARD ... uses Edition 1 ***/
...
static const ElementDefinitions ElementDefs[] =
	{
		...
		{   1, "pressure",                   "HPa" },
		{   2, "height",                     "Dm" },
		{   4, "temperature",                "degreesC" },
		{   5, "maximum_temperature",        "degreesC" },
		{   6, "minimum_temperature",        "degreesC" },
		{   8, "potential_temperature",      "degreesC" },
		{  10, "dewpoint",                   "degreesC" },
		{  11, "dewpoint_depression",        "Cdegrees" },
		{  12, "specific_humidity",          "dg/kg" },
		{  13, "relative_humidity",          "percent" },
		{  21, "wind_speed",                 "m/s" },
		{  23, "uu_wind",                    "m/s" },
		{  24, "vv_wind",                    "m/s" },
		{  30, "relative_vorticity",         "e-5/s" },
		{  31, "vorticity",                  "e-5/s" },
		{  40, "vertical_velocity",          "mb/s" },
		{  49, "precipitation",              "mm(H2O)" },
		{  61, "sea_temperature",            "ddegreesC" },
		{ 102, "height",                     "m" },
...
typedef struct
	...
	STRING		level_label;		/* FPA level label */
	} LevelDefinitions;
...
LOGICAL	next_gribfield_edition0(GRIBFIELD **);
