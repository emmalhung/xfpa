...
#	ifdef TIME_WINDS
	if ( npos>1 )
		...
		(void) fprintf(stdout, "winds_from_equations: %d points %d.%.6d sec\n",
				npos, nsec, nusec);
		}
#	endif /* TIME_WINDS */
...
#	ifdef TIME_WINDS
	if ( npos>1 )
		...
		long	nsec, nusec;
		get_stopwatch(&nsec, &nusec, NULL, NULL);
		(void) fprintf(stdout, "winds_from_values: %d points %d.%.6d sec\n",
				npos, nsec, nusec);
		}
#	endif /* TIME_WINDS */
...
#	ifdef TIME_WINDS
	if ( npos>1 )
		...
		long	nsec, nusec;
		get_stopwatch(&nsec, &nusec, NULL, NULL);
		(void) fprintf(stdout, "gradient_wind_function: %d points %d.%.6d sec\n",
				npos, nsec, nusec);
		}
#	endif /* TIME_WINDS */
